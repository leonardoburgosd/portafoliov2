...
const FirebaseIcon: React.FC<svgProps> = ({ ancho, alto, title }) => {
    return (
        <svg viewBox="0 0 256 351" width={ancho} height={alto} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
