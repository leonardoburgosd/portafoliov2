...
const MysqlIcon: React.FC<svgProps> = ({ ancho, alto }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={ancho} height={alto} preserveAspectRatio="xMidYMid" viewBox="0 0 256 252">
