...
const XamarinIcon: React.FC<svgProps> = ({ ancho, alto, title }) => {
    return (
        <svg width={ancho} height={alto} preserveAspectRatio="xMidYMid" viewBox="-.857 0 257.714 227.78" xmlns="http://www.w3.org/2000/svg">
